...
Mobile.verifyElementVisible(findTestObject('Login Page/Dashboard/txt - do not have account'), 0)

Mobile.verifyElementVisible(findTestObject('Login Page/Dashboard/btn - ADD ACCOUNT'), 0)
